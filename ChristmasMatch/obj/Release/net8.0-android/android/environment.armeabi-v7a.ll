...
@dso_cache = dso_local local_unnamed_addr global [504 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1053390623, ; hash 0x3ec9771f, from name: aot-FmgLib.MauiMarkup.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1161037313, ; hash 0x45340601, from name: aot-ChristmasMatch
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1715673895, ; hash 0x66431b27, from name: libaot-FmgLib.MauiMarkup.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FmgLib.MauiMarkup.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	...
	%struct.DSOCacheEntry {
		i64 1809459922, ; hash 0x6bda2ad2, from name: libaot-ChristmasMatch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChristmasMatch.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 2048700687, ; hash 0x7a1cb10f, from name: libaot-ChristmasMatch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChristmasMatch.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 2333986219, ; hash 0x8b1dcdab, from name: aot-FmgLib.MauiMarkup
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FmgLib.MauiMarkup.dll.so
		ptr null; void* handle (0x0)
	}, ; 268
	...
	%struct.DSOCacheEntry {
		i64 2808576844, ; hash 0xa7677b4c, from name: FmgLib.MauiMarkup
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FmgLib.MauiMarkup.dll.so
		ptr null; void* handle (0x0)
	}, ; 332
	...
	%struct.DSOCacheEntry {
		i64 3095943514, ; hash 0xb888595a, from name: libaot-FmgLib.MauiMarkup
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FmgLib.MauiMarkup.dll.so
		ptr null; void* handle (0x0)
	}, ; 376
	...
	%struct.DSOCacheEntry {
		i64 3434900096, ; hash 0xccbc6a80, from name: aot-ChristmasMatch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChristmasMatch.dll.so
		ptr null; void* handle (0x0)
	}, ; 409
	...
	%struct.DSOCacheEntry {
		i64 3470568559, ; hash 0xcedcac6f, from name: ChristmasMatch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChristmasMatch.dll.so
		ptr null; void* handle (0x0)
	}, ; 412
	...
	%struct.DSOCacheEntry {
		i64 4023229813, ; hash 0xefcd9d75, from name: ChristmasMatch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ChristmasMatch.dll.so
		ptr null; void* handle (0x0)
	}, ; 471
	...
	%struct.DSOCacheEntry {
		i64 4273648008, ; hash 0xfebab188, from name: FmgLib.MauiMarkup.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FmgLib.MauiMarkup.dll.so
		ptr null; void* handle (0x0)
	}, ; 499
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [114 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
